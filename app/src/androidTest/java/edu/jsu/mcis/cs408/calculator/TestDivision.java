...
public class TestDivision {
    ...
    public void testButtonPress_Division1() {
        Arrays.stream(parseEquation("8/4=")).forEach(i -> i.perform(click()));
    ...
    public void testButtonPress_Division3() {
        Arrays.stream(parseEquation("10/")).forEach(i -> i.perform(click()));
        for(int i = 0; i < 5; i++) {
    ...
    public void testButtonPress_Division4() {
        Arrays.stream(parseEquation("8//0=")).forEach(i -> i.perform(click()));
    ...
    public void testButtonPress_Division6() {
        Arrays.stream(parseEquation("-1=/10=")).forEach(i -> i.perform(click()));
